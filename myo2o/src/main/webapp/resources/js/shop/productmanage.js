$(function () {
    ...
    var listUrl = '/myo2o/shop/listproductsbyshop?pageIndex=1&pageSize=9999&shopId=' + shopId;
    ...
    $('#new').click(function () {
        window.location.href = '/myo2o/shop/productedit?shopId=' + shopId;
    });

    $("#shopmanage").click(function () {
        window.location.href = "/myo2o/shop/shopmanage?shopId=" + shopId;
    });
