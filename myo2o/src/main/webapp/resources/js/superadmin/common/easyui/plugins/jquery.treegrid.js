...
(function ($) {
    ...
    function _59(_5a, _5b, _5c, _5d, _5e) {
        ...
        $.ajax({
            type: _5f.method, url: _5f.url, data: _61, dataType: "json", success: function (_63) {
    ...
    $.fn.treegrid = function (_c2, _c3) {
        ...
        return this.each(function () {
            ...
            if (_c4) {
                ...
                $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _c2),
                    data: []
                });
            }
            _1(this);
    ...
    $.fn.treegrid.parseOptions = function (_ca) {
        var t = $(_ca);
        return $.extend({}, $.fn.datagrid.parseOptions(_ca), {
            treeField: t.attr("treeField"),
            animate: (t.attr("animate") ? t.attr("animate") == "true" : undefined)
        });
    };
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, onBeforeLoad: function (row, _cb) {
