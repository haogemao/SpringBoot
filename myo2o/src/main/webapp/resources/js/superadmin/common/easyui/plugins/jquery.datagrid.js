...
(function ($) {
    ...
    function _39(_3a) {
        ...
        _3c.panel($.extend({}, _3b, {
            doSize: false, onResize: function (_3d, _3e) {
                setTimeout(function () {
                    _8(_3a);
                    _6e(_3a);
    ...
    function _139(_13a, _13b) {
        ...
        function _13f() {
            $.ajax({
                type: opts.method, url: opts.url, data: _13d, dataType: "json", success: function (data) {
                    setTimeout(function () {
                        _140();
                    }, 0);
                    _95(_13a, data);
    ...
    $.fn.datagrid.parseOptions = function (_1ad) {
        var t = $(_1ad);
        return $.extend({}, $.fn.panel.parseOptions(_1ad), {
