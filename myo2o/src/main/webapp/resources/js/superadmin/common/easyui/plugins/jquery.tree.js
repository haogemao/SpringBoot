...
(function ($) {
    ...
    function _15(_16) {
        ...
        _18.find("div.tree-node").draggable({
            disabled: false, revert: true, cursor: "pointer", proxy: function (_19) {
            ...
            accept: "div.tree-node", onDragOver: function (e, _1a) {
                var _1b = _1a.pageY;
    ...
    function _56(_57, ul, _58, _59) {
        ...
        $.ajax({
            type: _5a.method, url: _5a.url, data: _58, dataType: "json", success: function (_5e) {
